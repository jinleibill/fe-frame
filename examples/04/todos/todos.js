...
const TodoItem = defineComponent({
    ...
    render() {
        ...
        return isEditing
            ? this.renderInEditMode(edited, isEditing)
            : this.renderInViewMode(original, isEditing)
    },
    renderInEditMode(edited, isEditing) {
        return h('li', { key: isEditing }, [
            h('input', {
                value: edited,
                on: {
    ...
    renderInViewMode(original, isEditing) {
        return h('li', { key: isEditing }, [
            h(
                'span',
